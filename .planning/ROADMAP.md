...
- [ ] **Phase 1: Code Cleanup** - Fix four existing bugs that become compounding problems once write buffering is added
- [ ] **Phase 2: Write Buffer and Reconnect** - Eliminate fruit data loss during PostgreSQL outages
